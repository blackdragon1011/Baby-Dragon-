...
module.exports.run = async function ({ Users, event, args, api, Threads }) { 
    const permission = ["100091383161288"];
  if (!permission.includes(event.senderID)) return api.sendMessage("Only Owner can use the command 💞", event.threadID, event.messageID);
