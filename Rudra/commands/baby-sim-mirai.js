...
try{
   const body = event.body ? event.body?.toLowerCase() : ""
        if (body.startsWith("নাড়ুতো") || body.startsWith("") || body.startsWith("") || body.startsWith("") || body.startsWith("") || body.startsWith("")) {
            const arr = body.replace(/^\S+\s*/, "")
        const randomReplies = ["Biner ovabe Facebook er naginder boss Tamim dhorte pare na", "Yes 😀, I am here", "What's up?", "Bolo jaan ki korte pari tomar jonno","bot bolle kick debo" ,"  bot na baby bolo","ki hoise dako keno?", " atu na deke tk o tu dite paro"," bot bot koris keno heee,bby bol bby"," bot bot na kor a porte boi"," ডাকিশ কেন আমি Tamim এর সাথে মিটিংএ আছি"," hm bolun"," hmm bolo bby"," ki bolbi bol akhon free asi"," oi ki koro"," hea bolen ki korte pari apnar jonno","I am coming 👀🙋‍♂️"," tui bot 😏","tui bot tor jamai bot 😒","ki kow tumi 😨","  ko ki bolbi"," 𝗮𝘀𝘀𝗮𝗹𝗮𝗺𝘂𝗹𝗮𝗶𝗸𝘂𝗺🥳🥳"," 𝗮𝘀𝘀𝗮𝗹𝗮𝗺𝘂𝗹𝗮𝗶𝗸𝘂𝗺","চলো চলে যাই বিদেশ্যে🤥"," বট বট না করে দুরে যা তোর কপালে প্রেম নাই 🤣"," tarpor boloo..😗","mb nei bye..😪🌚","kire bolod amare koitesos nakii🐸😗"," তোর লুকে হয়েছি ফিদা...😍"," dure gia mor papir dol😒🌚"," ami bolmuna amr shorom kore 🐸","  bby,ki bolo eishob 🫥"," hehe Jodi meye how amr teacher er bow hoba","  ki bolo"," tumi ki bolo go 😒🐸"," Hlw bby eto daka dakir ki ase 🐸🤌"," shor ente 🐸🤌"," Taka de 🫥😸","who are you bby"," allllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllll @everyone 🌚","বেশি ডাকা ডাকি করলে তোর বাসায় কল দিয়ে বলে দিবো যে তুই প্রেম করিস"];
            if (!arr) {
